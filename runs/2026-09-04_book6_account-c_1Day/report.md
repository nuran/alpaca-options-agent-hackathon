...
|---|---:|---:|---:|---:|---:|
| **Strategy** | -3.79% | -1.48% | -12.96% | -0.14 | $96,210 |
...
|---:|---:|---:|---:|---:|---:|---:|
| 1% | 18.23% | 317 | 80.8% | 1.31 | -8.91% | 0.86 |
| 3% | -3.79% | 312 | 76.9% | 0.94 | -12.96% | -0.14 |
| 6% | -25.11% | 325 | 71.7% | 0.64 | -28.23% | -1.21 |

## Trade statistics

- Trades: **312** (240 wins / 72 losses)
- Win rate: **76.9%**
- Profit factor: **0.94**
- Average trade: **$-12.15**  (win $255.30 / loss $903.65)
- Expectancy per trade: **$-12.15**
- Largest win / loss: $1,173.33 / $-4,509.49
- Longest drawdown: 534 sessions
...
| | P&L | trades |
|---|---:|---:|
| underlying up | $49,804 | 198 |
| underlying down | $-53,594 | 114 |

Asymmetry **4%** — both sides contribute.
...
- Credit collected: **$98,040**; P&L left: **$-3,790** (-3.9% of credit)
- Mean credit/width: **0.087** → breakeven WR **91.3%**; actual **76.9%**; gap **-14.4%**
- Tail (|pnl| > half max_loss): **8** trades, $-22,343

| exit | n | P&L | avg | worst |
|---|---:|---:|---:|---:|
| expiry | 41 | $5,312 | $130 | $-3,167 |
| stop_loss | 70 | $-59,029 | $-843 | $-4,509 |
| take_profit | 201 | $49,928 | $248 | $44 |
